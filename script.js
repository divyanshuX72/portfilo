...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ─── CONTACT FORM ───
    // Form submission logic has been moved to contact.js (modular, production-ready).
    // Toast notifications & button ripple effects are handled there as well.
    ...
    if (preloader) {
        ...
        // Fast 0.1-second loading simulation
        function simulateLoadingFast() {
            const duration = 100; // 0.1 second total
